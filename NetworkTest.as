...
class NetworkTest
{
	...
	void Fiber()
	{
		// Fiber() is called each frame, and we don't want to keep going after a
		// little while, so we stop if this is true.
		if (m_stop) {
			return;
		}
		...
		// We don't need to continue going from this point.
		m_stop = true;
	}
}
